...
TetrisSong <- [
  // 1
  { note = NOTE_E6, duration = 4 },
  { note = NOTE_B5, duration = 8 },
  { note = NOTE_C6, duration = 8 },
  { note = NOTE_D6, duration = 4 },
  { note = NOTE_C6, duration = 8 },
  { note = NOTE_B5, duration = 8 },
  // 2
  { note = NOTE_A5, duration = 4 },
  { note = NOTE_A5, duration = 8 },
  { note = NOTE_C6, duration = 8 },
  { note = NOTE_E6, duration = 4 },
  { note = NOTE_D6, duration = 8 },
  { note = NOTE_C6, duration = 8 },
  // 3
  { note = NOTE_B5, duration = 2.66 },
  { note = NOTE_C6, duration = 8 },
  { note = NOTE_D6, duration = 4 },
  { note = NOTE_E6, duration = 4 },
  // 4
  { note = NOTE_C6, duration = 4 },
  { note = NOTE_A5, duration = 4 },
  { note = NOTE_A5, duration = 8 },
  { note = NOTE_A5, duration = 8 },
  { note = NOTE_B5, duration = 8 },
  { note = NOTE_C6, duration = 8 },
  // 5 
  { note = NOTE_D6, duration = 2.66 },
  { note = NOTE_F6, duration = 8 },
  { note = NOTE_A6, duration = 4 },
  { note = NOTE_G6, duration = 8 },
  { note = NOTE_F6, duration = 8 },
  // 6
  { note = NOTE_E6, duration = 2.66 },
  { note = NOTE_C6, duration = 8 },
  { note = NOTE_E6, duration = 4 },
  { note = NOTE_D6, duration = 8 },
  { note = NOTE_C6, duration = 8 },
  // 7  
  { note = NOTE_B5, duration = 4 },
  { note = NOTE_B5, duration = 8 },
  { note = NOTE_C6, duration = 8 },
  { note = NOTE_D6, duration = 4 },
  { note = NOTE_E6, duration = 4 },
  ...
  { note = NOTE_A5, duration = 4 },
  { note = NOTE_A5, duration = 4 },
  { note = NOTE_REST, duration = 4 }
 ];

Piezo <- Tone(hardware.pin8);
tetris <- Song(Piezo, TetrisSong);
tetris.Play();
